...
증권 브리핑 데이터를 바탕으로 **약 10분짜리** 방송 스크립트를 JSON 형식으로 작성하세요.
작성일: {TODAY}

## ★ 10분 영상 설계 원칙 (필수)
- 전체 나레이션 분량: 약 2,500~3,000어절 (한국어 평균 낭독 속도 약 300어절/분 기준)
...
"""
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user",   "content": (
                "다음 브리핑 데이터를 바탕으로 약 10분 분량의 KBS 머니올라 방송 스크립트를 작성해주세요.\n"
